...
const IResourceProvider::SpriteSheet& ResourceManager::getSpriteSheet(SpriteSheetId id) const
{
    return m_spriteSheets[static_cast<size_t>(id)];
}

const IResourceProvider::SpriteFrame& ResourceManager::getSpriteFrame(SpriteId id) const
{
...
void ResourceManager::loadProceduralTextures()
{
    ...
    m_images[static_cast<size_t>(ImageId::BottomControlBarBg)] =
        decodeImageFromBinaryData(BinaryData::bottomcontrolbar_png, BinaryData::bottomcontrolbar_pngSize);
}
