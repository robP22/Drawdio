...
makeDefinition(DspModuleType::BYPASS, "Bypass",             "Mix",    "",       "",       ""),
        ...
        makeDefinition(DspModuleType::GLITCH_STUTTER,     "Glitch Stutter",  "Intens", "Mix",    "",       ""),
        makeDefinition(DspModuleType::DIFFUSED_REVERB,    "Diffused Reverb", "Mix",    "",       "",       "Decay"),
        ...
        makeDefinition(DspModuleType::SPECTRAL_FREEZE,    "Spectral Freeze",  "Mix",    "Freeze","",       ""),
        makeDefinition(DspModuleType::FREQ_SHIFTER,       "Frequency Shifter","Shift",  "Mix",   "",       ""),
        makeDefinition(DspModuleType::REVERSE,            "Reverse",          "Mix",    "",      "",       "Density"),
